...
function render( game )
{
    ...
    let guessedLettersElement = document.getElementById("guessedLetters");
    guessedLettersElement.innerHTML = "<strong>Guessed Letters:</strong> " + game.getGuessedLetters().join(", ");
